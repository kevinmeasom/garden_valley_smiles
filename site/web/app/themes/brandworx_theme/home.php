        ...
        <?php if ( have_posts() ) : ?>
            ...
            <div id="archive_page" class="content-wrapper">
                <header class="container-xl page-header">
                    <h1 class="page-title cat-title">Blog</h1>
                </header><!-- .page-header -->
                ...
                <div class="archive-bg">
                    ...
                    <!-- Load More -->
                    <?php echo do_shortcode('[ajax_load_more container_type="div" css_classes="archive-items" post_type="post" posts_per_page="4" offset="4" pause="true" scroll="false" transition_container="true" button_label="Load More..."]'); ?>
                </div>
            </div>
